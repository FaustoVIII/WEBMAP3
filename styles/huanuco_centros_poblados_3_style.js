var size = 0;
var placement = 'point';
function categories_huanuco_centros_poblados_3(feature, value, size, resolution, labelText,
...
case 'PUEBLO':
                    return [ new ol.style.Style({
        image: new ol.style.Circle({radius: 4.199999999999999 + size,
...
default:
        ...
        image: new ol.style.Circle({radius: 4.0 + size,
            stroke: new ol.style.Stroke({color: 'rgba(35,35,35,1.0)', lineDash: null, lineCap: 'butt', lineJoin: 'miter', width: 0}), fill: new ol.style.Fill({color: 'rgba(228,80,238,1.0)'})}),
        text: createTextStyle(feature, resolution, labelText, labelFont,
                              labelFill, placement, bufferColor,
                              bufferWidth)
    })];
...
var style_huanuco_centros_poblados_3 = function(feature, resolution){
    var context = {
        feature: feature,
        variables: {}
    };
...
var style = categories_huanuco_centros_poblados_3(feature, value, size, resolution, labelText,
